...
const DeviceTab = () => {
  ...
  const [logs, setLogs] = useState([
    ...
    { id: 3, timestamp: '2026-01-29 10:22:18', status: 'Drowsiness Detected', smsSent: false },
    { id: 4, timestamp: '2026-01-29 09:55:27', status: 'Drowsiness Detected', smsSent: false },
  ]);
